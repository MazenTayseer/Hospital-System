...
public class CompletedState implements IAppointmentState {
    ...
    public void nextState(Appointment appointment) {
        throw new BadRequestException("Cannot move to next state from Completed state.");
    }

    @Override
    public void cancel(Appointment appointment) {
        throw new BadRequestException("Cannot cancel appointment in Completed state.");
    }

    @Override
    public void decline(Appointment appointment) {
        throw new BadRequestException("Cannot decline appointment in Completed state.");
    }
}
